                ...
                success: function(response) {
                    if (response.status != 'success') {
                        Swal.fire({
                            ...
                            text: response
                            .message, // Use response.message as the error message content
                        ...
                        $(".submit_button").html("{{ __('admin.add') }}").attr('disable',
                            false);
                        Swal.fire({
                            position: 'top-start',
                            type: 'success',
                            ...
                            text: response
                            .message, // Use response.message as the message content
                            showConfirmButton: false,
                            timer: 1500,
                            confirmButtonClass: 'btn btn-primary',
                            buttonsStyling: false,
