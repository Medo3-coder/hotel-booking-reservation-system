...
<!-- Room Area -->
@include('site.home.parts.rooms')
<!-- Room Area End -->

<!-- Book Area Two-->
@include('site.home.parts.booking')
<!-- Book Area Two End -->

<!-- Services Area  -->
@include('site.home.parts.services')
<!-- Services Area End -->

<!-- Team Area Three -->
@include('site.home.parts.team')
<!-- Team Area Three End -->

<!-- Testimonials Area Three -->
@include('site.home.parts.testimonials')
<!-- Testimonials Area Three End -->

<!-- FAQ Area -->
@include('site.home.parts.faq')
<!-- FAQ Area End -->

<!-- Blog Area -->
@include('site.home.parts.blog')
<!-- Blog Area End -->
